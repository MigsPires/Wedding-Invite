...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center p-4" style={{ backgroundImage: "url('public/fundo.jpeg')" }}>
      ...
      <div className="bg-white bg-opacity-80 rounded-2xl shadow-xl p-8 text-center max-w-md animate-fade-in">
        ...
        <div className="text-sm text-[#6B3E26] mb-2 animate-fade-in-delay">
          <p>📍 <strong>Igssssreja:</strong> <a href="https://maps.app.goo.gl/qdz9XYx79PH3uSGL6" target="_blank" className="underline transition transform hover:scale-110">Igreja São Salvador de Torgueda, Vila Real</a></p>
          <p>📍 <strong>Fessssta:</strong> <a href="https://maps.app.goo.gl/ZjGTyL7DZgzwnNe46" target="_blank" className="underline transition transform hover:scale-110">Quinta dos Jasmins, Paços de Ferreira</a></p>
        </div>
