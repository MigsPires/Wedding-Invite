...
const App = () => {
  ...
  return (
    <div style={{ fontFamily: "Segoe UI, Tahoma, Geneva, Verdana, sans-serif", backgroundColor: "#E2725B", color: "#5c3a2e", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "2rem" }}>
      <h1 style={{ fontSize: "2.5rem", marginBottom: "0.5rem" }}>Beatriz & Rui</h1>
      <h2 style={{ fontWeight: "normal", marginBottom: "1.5rem" }}>22 Maio 2026</h2>
